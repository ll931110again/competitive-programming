# Toolchains for this repo: demo prelude setup with classic Kotlin (no kotlincd worker).
...
def cp_toolchains():
    ...
    # Override via: buck2 ... --config java.java_home=$JAVA_HOME
    java_home = read_root_config("java", "java_home", "/usr/lib/jvm/java-17-openjdk-amd64")
    system_java_tool(
        name = "java_tool",
    ...
    # Classic kotlinc (bundled compiler JAR) — works outside Meta infra.
